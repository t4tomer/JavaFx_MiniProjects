...
package Examples_from_book.ColorChooser;
...
// explanation for <Number> :
/* 
 * 
 * Generics in Java allow you to create classes, interfaces, 
 * and methods that can work with any data type. In this case, 
 * Number is a superclass of classes that wrap primitive numeric types such as:
 *  Integer, Double, Float, etc. By specifying <Number>, you're essentially stating 
 * that the ChangeListener will deal with values of type Number.
 */
